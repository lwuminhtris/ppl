...
class ASTGeneration(BKITVisitor):
    ...
    def visitVar_decl(self, ctx: BKITParser.Var_declContext):  # -> List[VarDecl]:
    ...
    def visitFull_variable(self, ctx: BKITParser.Full_variableContext):  # -> VarDecl:
    ...
    def visitFunc_decl(self, ctx: BKITParser.Func_declContext):  # -> List[FuncDecl]:
    ...
    def visitFunc_param(self, ctx: BKITParser.Func_paramContext):  # -> List[VarDecl]:
    ...
    def visitParam_list(self, ctx: BKITParser.Param_listContext):  # -> List[VarDecl]:
        return [
    ...
    def visitExpr_list(self, ctx: BKITParser.Expr_listContext):  # -> List[Expr]:
    ...
    def visitIndex_operators(
        self, ctx: BKITParser.Index_operatorsContext
    ):  # -> List[Expr]:
